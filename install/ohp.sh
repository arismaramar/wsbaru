...
cd 
wget -O /usr/local/bin/ohp "https://raw.githubusercontent.com/${GitUser}/wsbaru/main/ohp"
...
[Unit]
Description=Direct Squid Proxy For OpenVPN TCP By TESTVPN
